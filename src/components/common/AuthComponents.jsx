...
export function SignUp({ switchToSignIn }) {
    ...
    return (
        <div className="h-[100vh] flex items-center justify-center">
            <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border dark:border-zinc-900 border-zinc-100">
                ...
                <form className="my-8" onSubmit={handleSubmit}>
                    <div className="mb-4 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
                        <LabelInputContainer>
                            ...
                            <Input id="firstname" placeholder="Tyler" type="text" value={form.firstname} onChange={handleChange} required />
                        </LabelInputContainer>
                        <LabelInputContainer>
                            <Label htmlFor="lastname">Last name</Label>
                            <Input id="lastname" placeholder="Durden" type="text" value={form.lastname} onChange={handleChange} required />
                        </LabelInputContainer>
                    </div>
                    <LabelInputContainer className="mb-4">
                        <Label htmlFor="email">Email Address</Label>
                        <Input id="email" placeholder="projectmayhem@fc.com" type="email" value={form.email} onChange={handleChange} required />
                    </LabelInputContainer>
                    <LabelInputContainer className="mb-4">
                    ...
                    <div className="flex flex-col space-y-4">
                        <button type="button" className="group/btn shadow-input relative flex h-10 w-full items-center justify-start space-x-2 rounded-md bg-gray-50 px-4 font-medium text-black dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_#262626] cursor-pointer">
                    ...
                    <p className="text-center mt-10 text-sm">
                        Already a member?{" "}
                        <button onClick={switchToSignIn} className="underline cursor-pointer">Sign in</button>
                    </p>
                </form>
            </div>
        </div>
        ...
        <div className="h-[100vh] flex items-center justify-center">
            <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border dark:border-zinc-900 border-zinc-100">
                ...
                <form className="my-8" onSubmit={handleSubmit}>
                    ...
                    <p className="text-center mt-10 text-sm">
                        First time here?{" "}
                        <button onClick={switchToSignUp} className="underline cursor-pointer">Sign up</button>
                    </p>
                </form>
            </div>
        </div>
