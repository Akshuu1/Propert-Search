                    ...
                    {properties.map((property) => (
                        ...
                        >
                            <div className="relative w-full h-48 sm:h-56 bg-zinc-300 dark:bg-zinc-700 overflow-hidden">
                                <Image
                                    src={property.images || `https://placehold.co/600x400/2e2e2e/ffffff?text=${encodeURIComponent(property.name || 'Property')}`}
                                    alt={property.title || 'Property Image'}
                                    className="w-full h-full object-cover transition-transform duration-300 hover:scale-105"
                                    onError={(e) => {
                                        e.target.onerror = null;
                                        e.target.src = `https://placehold.co/600x400/2e2e2e/ffffff?text=No+Image`;
                                    }}
                                    width={600}
                                    height={400}
                                />
